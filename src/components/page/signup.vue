  ...
  methods: {
    ...
    signup() {
      ...
      this.$refs.loginForm.validate(valid => {
        if (valid) {
          ///////////////////////////////////////////////////
          // localStorage.setItem("validateCode","1234");
          console.log("signup.valid = "+valid)
          console.log("signup.validateCode = "+localStorage.getItem("validateCode"))
          console.log("signup.this.loginForm.message = "+this.loginForm.message)
          ////////////////////////////////////////////////////
