        ...
        <div class="container">
            <div class="handle-box">
                ...
                <el-button
                    ...
                    @click="delAllSelection"
                >批量删除</el-button>
                <el-select v-model="query.address" placeholder="单位" class="handle-select mr10">
            ...
            >
                ...
                <el-table-column prop="school" label="单位" align="center"></el-table-column>
                <el-table-column label="账户状态" align="center">
                    <template slot-scope="scope">
                        <el-tag
                            :type="scope.row.state==='可用'?'success':(scope.row.state==='不可用'?'danger':'')"
